...
| C#           | 13.22s (2)            | net9, Visual Studio 2022                            |
...
(2) Safe. Update to .net 9. For standard C# code, elapse time is ~13.20 s. I mean by "standard" one to which extreme optimizations were not applied. In update 17-10-21 I used a Jagged array to replace the multidimensional array, that improved the time of C#, version without pointers (standard) by ~9%
